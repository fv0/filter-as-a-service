...
(function(global) {
    ...
    */
    ...
    Endpoint.prototype.products_search= function(terms, pageNumber, callback) {
        var data = {
            _source: true,
            ...
            query: {
				"dis_max": {
					queries: [
						{"wildcard": {"name_translations.de" : terms}},
						{"wildcard": {"name_translations.it" : terms}},
						{"wildcard": {"name_translations.fr" : terms}},
						{"wildcard": {"name_translations.en" : terms}}
					]
				}
			}
        };
